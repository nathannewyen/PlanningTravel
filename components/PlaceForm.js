...
import { addPlace, EventBus } from '../utils';
          ...
          <form className="relative w-full py-10 px-6 md:p-10" onSubmit={onSubmit}>
            ...
            {isErrorShown && (
              ...
              <div className="flex justify-between mt-10">
                <button
                  className="px-6 py-3 bg-green-500 hover:bg-green-400 focus:outline-none focus:bg-green-400 rounded-lg text-white font-small tracking-wide"
                  type="submit">
                  {isEditing ? 'Save' : 'Add'}
                </button>
              </div>
