...
const Nav = ({authed}) => (
    <nav className="flex items-center justify-between flex-wrap w-full py-4 px-6 bg-green-400">
        ...
        <div>
            ...
            <button
                className="inline-block px-4 py-3 border rounded text-white text-md leading-none border-white hover:border-transparent hover:text-green-500 hover:bg-white focus:outline-none focus:bg-white focus:text-green-500"
